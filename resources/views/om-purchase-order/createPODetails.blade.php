...
@section('top-content')
    <div class="col-lg-10">
        <h2><a href="{{ url('/om') }}">Purchase Order Detail </a> / Add</h2>
    </div>
@endsection
@section('style')
    <style>
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-content">
                ...
                <form role="form" id="form" class="form-horizontal" action="{!! url('update_ompo', $Quotation->id) !!}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label class="control-label col-sm-2">Purchase Order Number </label>
                        <div class="col-sm-10">
                            <input type="text" data-provide="typeahead" class="form-control" id="po_number" value="{!! $data['po_number'] !!}" name="po_number" placeholder="Purchase Order number..." />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-sm-10">
                            <textarea class="form-control" id="description" placeholder="Purchase order description">{!! $data['description'] !!}</textarea>
                        </div>
                    </div> 
                    <div class="form-group">
