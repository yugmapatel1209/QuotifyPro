...
@section('top-content')
<div class="col-lg-10">
    <h2>Om Electricals - Purchase Order</h2>
</div>
@endsection
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <form action="{!! route('ompo.create') !!}" class="device-content-center">
                    <button class="btn btn-sm btn-primary pull-right m-t-n-xs"><strong><i class="fa fa-plus"></i> Add Purchase Order</strong></button>
                </form>
            </div>
    ...
    var oTable = $('#ascend-tables').DataTable({
        ...
        columns: [
            ...
            // { data: 'date' },
            {
                ...
                "data": "id",
                "render": function (data, type, row) {
                    var button = '<a href="{{ url('ompo') }}' + '/' + row['id']  + '/edit" class="product-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
                    button += '<a href="{{ url('ompo') }}' + '/' + row['id'] + '" class="product-table-info" data-toggle="tooltip" title="View" data-original-title="View"><i class="fa fa-eye"></i></a>';
