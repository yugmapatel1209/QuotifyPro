                ...
                <div class="ibox-content">
                    ...
                    <form role="form" id="form" class="form-horizontal" action="{!! route('om.store') !!}"
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Is Laterpad Image</label>
                            <div class="col-sm-10">
                                <label class="checkbox-inline i-checks"> <input type="checkbox" value="1"
                                        name="is_laterpad_image" id="is_laterpad_image" checked> Yes </label>
                            </div>
                        </div>
                        <div class="form-group"><label class="col-sm-2 control-label">Status</label>
                            <div class="col-sm-10">
                                <label class="checkbox-inline i-checks"> <input type="checkbox" value="1"
                                        name="is_active" id="is_active" checked> Yes </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" placeholder="Quantity" class="form-control"
                                                        id="quantity" name="quantity[1]" required />
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" placeholder="Transportation charges" class="form-control"
                                                        id="sales_amount" name="transportation_charges[1]" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-10">\
                                    <div class="ibox float-e-margins">\
                                        <div class="ibox-content">\
                                            ...
                                            <div class="form-group">\
                                                <Unitlabel class="control-label col-sm-1">Including GST </Unitlabel>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Including GST" class="form-control" id="including_gst_' + len+'" name="including_gst[' + len + '] " />\
                                                    </div>\
                                                    <label class="control-label col-sm-1">Excluding GST </label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Excluding GST" class="form-control" id="excluding_gst_'+len+'" name="excluding_gst[' + len + '] " />\
                                                    </div>\
                                                    <label class="control-label col-sm-1">Discount%</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Discount %" class="form-control" id="discount_'+len+'" name="discount[' + len + ']" />\
                                                    </div>\
                                                </div>\
                                                <div class="form-group">\
                                                <label class="control-label col-sm-1">Final Amount</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Final Amount" class="form-control" id="final_amount_'+len+'" name="final_amount[' + len + ']" />\
                                                    </div>\
                                                    <label class="control-label col-sm-1">Profit%</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Profit %" class="form-control" id="profit" name="profit_percentage[' + len + ']" />\
                                                    </div>\
                                                    <label class="control-label col-sm-1">Original Rate</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Original Rate" class="form-control" id="original_rate" name="original_rate[' +len + ']" />\
                                                    </div>\
                                                </div>\
                                                <div class="form-group">\
                                                <label class="control-label col-sm-1">Purchase Amount</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Purchase Amount" class="form-control" id="purchase_amount" name="purchase_amount[' + len + ']" />\
                                                    </div>\
                                                    <label class="control-label col-sm-1">Sales Amount</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Sales Amount" class="form-control" id="profit" name="sales_amount[' +len + ']" />\
                                                    </div>\
                                                    <label class="control-label col-sm-1">Transportation charges</label>\
                                                <div class="col-sm-3">\
                                                    <input type="text" placeholder="Transportation charges" class="form-control" id="transportation_charges" name="transportation_charges[' +len + ']" />\
                                                    </div>\
                                                </div>\
                                        </div>\
                                    </div>\
