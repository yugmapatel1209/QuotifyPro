    ...
    var oTable = $('#ascend-tables').DataTable({
        ...
        columns: [
            ...
            { data: 'date' },
            {
                ...
                "data": "ExerciseId",
                "render": function (data, type, row) {
                    var button = '<a href="{{ url('earth') }}' + '/' + row['id']  + '/edit" class="product-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
                    button += '<a href="{{ url('earth') }}' + '/' + row['id'] + '" class="product-table-info" data-toggle="tooltip" title="View" data-original-title="View"><i class="fa fa-eye"></i></a>';
