...
{{-- <link href="{{env('APP_URL').'/'.'public/PlaceHolder/Checkin360x16icon.png'}}" rel="icon"> --}}
...
<link href="{{ asset('public/css/plugins/dataTables/dataTables.bootstrap.css') }}" rel="stylesheet">
<link href="{{ asset('public/css/plugins/dataTables/dataTables.responsive.css') }}" rel="stylesheet">
<link href="{{ asset('public/css/plugins/dataTables/dataTables.tableTools.min.css') }}" rel="stylesheet">
