    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <form action="{!! route('exercises.create') !!}" class="device-content-center">
                    <button class="btn btn-sm btn-primary pull-right m-t-n-xs"><strong><i class="fa fa-plus"></i> Add Exercise</strong></button>
                </form>
            </div>
...
<script>
    ...
    var oTable = $('#ascend-tables').DataTable({
        ...
        processing : true,
        "oLanguage": {
            "sLengthMenu": "Display _MENU_ Exercise(s)",
        ...
        columns: [
            ...
            {                
                ...
                "render": function (data, type, row) {
                    return row.IsActive == 1 ? '<span class="label label-primary">Active</span>' : '<span class="label label-danger">Inactive</span>';
                }
            },

            {
                ...
                "data": "ExerciseId",
                "render": function (data, type, row) {
                    //<a href="{{ url('exercises') }}' + '/' + row['ExercisesMasterId']  + '/edit" class="product-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>\
                    var button = '<a href="{{ url('exercises') }}' + '/' + row['ExercisesMasterId'] + '" class="product-table-info" data-toggle="tooltip" title="View" data-original-title="View"><i class="fa fa-eye"></i></a>';
                    if(row['IsPublish'] == 0) {
                        //button += '<a href="{{ url('exercises') }}' + '/' + row['ExercisesMasterId']  + '/edit" class="product-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
                    }
                    button += '<a onclick="deleteData(\'' + row['ExercisesMasterId'] + '\')"  class="product-table-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>';
                    return button;
                }
            }
